...
export default function Header(props: { className?: string }) {
    return (
        <div className={cn('z-40 fixed top-0 flex justify-center items-center w-full', props.className)}>
            <div className="relative flex h-14 w-full items-center justify-between gap-5 border-b border-very-light-hover bg-background px-4 text-base backdrop-blur-md sm:mt-2 sm:h-fit sm:max-w-[450px] sm:justify-between sm:rounded-lg sm:border-transparent sm:bg-transparent sm:p-2 sm:text-lg">
